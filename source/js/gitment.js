...
var Gitment = (function(modules) { // webpackBootstrap
    // The module cache
...
(function(module, exports, __webpack_require__) {
    ...
    default = module.exports;
        ...
        function autorun(arg1, arg2, arg3) {
            ...
            var reaction = new Reaction(name,
            function() {
        ...
        var IDerivationState; (function(IDerivationState) {
        ...
        function spyReportEnd(change) {
            if (change) spyReport(objectAssign({},
            change, END_EVENT));
        ...
        declareIterator(ObservableArray.prototype,
        function() {
        ...
        Object.defineProperty(ObservableArray.prototype, "length", {
            ...
            addHiddenProp(ObservableArray.prototype, funcName,
            function() {
                this.$mobx.atom.reportObserved();
        ...
        declareIterator(ObservableMap.prototype,
        function() {
            return this.entries();
        });
