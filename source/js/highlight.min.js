...
var hljs = function() {
    ...
    q = (e, n) = >{
        ...
        /${n}`]||(console.log(`Deprecated as of ${e}. ${n}`),P[`${e}/$ {
            n
        }`] = !0)
    },
    G = Error();
    function Z(e, n, {
        ...
        r = {},
        s = {};
        for (let e = 1; e <= n.length; e++) s[e + a] = i[e],
        r[e + a] = !0,
        a += p(n[e - 1]);
        e[t] = s,
        e[t]._emit = r,
    ...
    function Q(e) {
        ...
        class i {
            ...
            exec(e) {
                ...
                return t && (this.regexIndex += t.position + 1, this.regexIndex === this.count && this.considerAll()),
                t
            }
        }
        ...
        function t(r, s) {
            const o = r;
            if (r.isCompiled) return o; [R, L, W, $].forEach((e = >e(r, s))),
            e.compilerExtensions.forEach((e = >e(r, s))),
            r.__beforeBegin = null,
            [D, I, B].forEach((e = >e(r, s))),
            r.isCompiled = !0;
            let l = null;
            return "object" == typeof r.keywords && r.keywords.$pattern && (r.keywords = Object.assign({},
            r.keywords), l = r.keywords.$pattern, delete r.keywords.$pattern),
            l = l || /\w+/,
    ...
    const J = t, Y = a, ee = Symbol("nomatch"), ne = t = >{
        ...
        function f(e, t, i, r) {
            ...
            function N(a, r) {
                ...
                if (y = r, "begin" === r.type) return (e = >{
                    ...
                    return a.skip ? A += t: (a.excludeBegin && (A += t), d(), a.returnBegin || a.excludeBegin || (A = t)),
                    b(a, e),
        ...
        function y(e) {
            ...
            const t = (e = >{
                ...
                if (t) {
                    const n = v(t[1]);
                    return n || (H(o.replace("{}", t[1])), H("Falling back to no-highlight mode for this block.", e)),
                    n ? t[1] : "no-highlight"
                }
    ...
    function Oe(e) {
        ...
        a = {
            ...
            isTrulyOpeningTag: (e, n) = >{
                ...
                const r = e.input.substring(t); ((i = r.match(/^\s*=/)) || (i = r.match(/^\s+extends\s+/)) && 0 === i.index) && n.ignoreMatch()
            }
        },
        i = {
            $pattern: _e,
    ...
    var Ke = Object.freeze({
        ...
        grmr_markdown: e = >{
            ...
            r = e.inherit(a, {
                ...
                contains: []
            }); a.contains.push(s), i.contains.push(r); let o = [n, t];
...
match:[/\. / , m(...xe, ...Me)],
        ...
        grmr_vbnet: e = >{
            ...
            return {
                ...
                contains: [{
                    className: "string",
                    begin: /"(""|[^/n])"C\b/},{className:"string ",begin:/" / ,
                    end: /"/,
                    illegal: /\n/,
                    contains: [{
                        begin: /""/
